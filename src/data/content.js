...
export const characterGraph = {
  nodes: [
    {
      ...
      relationships: [
        { target: 'rachel', label: '정비사 ↔ 사이보그 관계 / 연애감정에 가까울 특별함', type: 'special' },
        { target: 'naomi',  label: '레이첼의 식물을 이용한 더스트 분해제 제조법 전수', type: 'transfer' },
    ...
    },
    {
      ...
      relationships: [
        { target: 'jisu',   label: '호기심 → 특별함 → 감정 제어 장치 사건 → 싸운 후 헤어짐', type: 'conflict' },
    ...
    },
    {
      ...
      relationships: [
        ...
        { target: 'jisu',  label: '더스트 분해제 제조법 전수 받음', type: 'transfer' },
  ...
  edges: [
    { from: 'jisu',   to: 'rachel', label: '정비사↔사이보그/연애감정에 가까울 특별함', era: ['dust'],         type: 'special' },
    { from: 'rachel', to: 'jisu',   label: '호기심→특별함→싸운 후 헤어짐',            era: ['dust'],         type: 'conflict' },
    { from: 'jisu',   to: 'naomi',  label: '더스트 분해제 제조법 전수',                era: ['dust'],         type: 'transfer' },
